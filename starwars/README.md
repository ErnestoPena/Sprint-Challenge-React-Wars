...
- [ ] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
      React is a Javascript library. React tryes to solve the DOM manipulation overload by creating a virtual DOM which will compare with previous states and will render the data that has changed only. 
      React is easy to scale and mantain because it is build from many different components. Each components represent a different task or functionality within our website 

- [ ] What does it mean to _think_ in react?
      Think in React means to think in components rather than in objects. this components should be as generic as possible to promote reusability.  

- [ ] Describe state.
     The state in React is considered an object that holds some information that might change over the lifetime in a component.

- [ ] Describe props.
      Props is how we pass the states and properties to components. it is like a parameter that can hold objects to be used by different components  
